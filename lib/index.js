...
function generateClassDefinitionExpression(node) {
  ...
  var iifeParams = superClassId ? [superClassId] : [];
  var iifeArgs = superClassId ? [node.superClass] : [];

  function addPropertyDescriptor(property, key, value, isStatic, isComputed) {
